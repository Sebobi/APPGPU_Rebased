        ...
        for (int ii=0; ii < 2; ii++)
            for (int jj=0; jj < 2; jj++)
                for(int kk=0; kk < 2; kk++){
                    ...
                    Bxl += weight[ii][jj][kk]*Bxn_flat[id];
                    Byl += weight[ii][jj][kk]*Byn_flat[id];
                    Bzl += weight[ii][jj][kk]*Bzn_flat[id];
